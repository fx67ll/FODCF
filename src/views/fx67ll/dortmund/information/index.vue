        ...
        <el-tabs v-model="activeTab" type="border-card" class="main-tabs">
            ...
            <el-tab-pane label="赛季管理" name="season">
                ...
                <el-table :data="seasonList" border stripe v-loading="seasonLoading">
                    ...
                    <el-table-column prop="seasonCode" label="赛季编码"></el-table-column>
                    <el-table-column prop="seasonStartDate" label="开始日期"></el-table-column>
                    <el-table-column prop="seasonEndDate" label="结束日期"></el-table-column>
