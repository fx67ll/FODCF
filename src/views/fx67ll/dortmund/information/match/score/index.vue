  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="评分编号" prop="scoreId" v-if="isMoreQuery">
        <el-input v-model="queryParams.scoreId" placeholder="请输入评分编号" clearable @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="关联分析" prop="analysisId" v-if="isMoreQuery">
        <el-input v-model="queryParams.analysisId" placeholder="请输入关联的分析日志编号" clearable
          @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="关联比赛" prop="matchId" v-if="isMoreQuery">
        <el-input v-model="queryParams.matchId" placeholder="请输入关联的评分比赛编号" clearable
          @keyup.enter.native="handleQuery" />
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="scoreList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="扩展评分数据" align="center" prop="extraScoreStr" width="100" />
      <el-table-column label="比赛评分备注" align="center" prop="scoreRemark" width="230" />
    ...
    <el-dialog :title="title" :visible.sync="open" :close-on-click-modal="false" width="800px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="170px">
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="关联的分析日志编号" prop="analysisId">
              <el-input v-model="form.analysisId" placeholder="请输入关联的分析日志编号" disabled />
            </el-form-item></el-col>
          <el-col :span="12">
            <el-form-item label="关联的评分比赛编号" prop="matchId">
              <el-input v-model="form.matchId" placeholder="请输入关联的评分比赛编号" disabled />
            </el-form-item>
          </el-col>
          <el-col :span="12">
          ...
          <el-col :span="12">
            <el-form-item label="比赛评分版本" prop="scoreCalcRuleVersion">
              <el-input v-model="form.scoreCalcRuleVersion" placeholder="请输入比赛评分版本号" disabed />
            </el-form-item>
          </el-col>
          <el-col :span="24">
