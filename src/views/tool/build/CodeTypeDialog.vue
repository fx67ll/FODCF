<template>
  <div>
    <el-dialog v-bind="$attrs" v-on="$listeners" width="500px" :style="`top: ${getDialogVerticalOffset(296)}`"
      :modal-append-to-body="false" :close-on-click-modal="false" @open="onOpen" @close="onClose">
      <el-row :gutter="15">
